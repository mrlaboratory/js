...
for(var i=1;i<=10;i++){
  fancyText  =  '<div class="input-group mb-2 flex justify-center items-center"><input type="text" class="form-control input input-bordered w-full" value="'+crazyWithFlourishOrSymbols(text)+'" id="copy_'+ct+'" readonly="readonly"><div class="input-group-append"><span class="btn btn-primary input-group-text copybutton" style="cursor:pointer;" data-clipboard-action="copy" data-clipboard-target="#copy_'+ct+'">Copy</span></div></div>';
  ct++;
